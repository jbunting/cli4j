...
import io.bunting.cli4j.parser.ParametersDelegate;
import io.bunting.cli4j.parser.WrappedParameter;
...
public class Parameterized {
  ...
  // Either of these two
  private io.bunting.cli4j.parser.WrappedParameter m_wrappedParameter;
  private ParametersDelegate m_parametersDelegate;

  public Parameterized(io.bunting.cli4j.parser.WrappedParameter wp, ParametersDelegate pd,
  ...
  public static List<io.bunting.cli4j.parser.Parameterized> parseArg(Object arg) {
    List<io.bunting.cli4j.parser.Parameterized> result = Lists.newArrayList();
    ...
    while (!Object.class.equals(cls)) {
      for (Field f : cls.getDeclaredFields()) {
        ...
        if (annotation != null) {
          result.add(new io.bunting.cli4j.parser.Parameterized(new io.bunting.cli4j.parser.WrappedParameter((Parameter) annotation), null,
              f, null));
        } else if (dynamicParameter != null) {
          result.add(new io.bunting.cli4j.parser.Parameterized(new io.bunting.cli4j.parser.WrappedParameter((DynamicParameter) dynamicParameter), null,
              f, null));
        } else if (delegateAnnotation != null) {
          result.add(new io.bunting.cli4j.parser.Parameterized(null, (ParametersDelegate) delegateAnnotation,
              f, null));
        }
      }
    ...
    while (!Object.class.equals(cls)) {
      for (Method m : cls.getDeclaredMethods()) {
        ...
        if (annotation != null) {
          ...
          result.add(new io.bunting.cli4j.parser.Parameterized(new io.bunting.cli4j.parser.WrappedParameter((DynamicParameter) annotation), null,
              null, m));
        } else if (delegateAnnotation != null) {
          result.add(new io.bunting.cli4j.parser.Parameterized(null, (ParametersDelegate) delegateAnnotation,
              null, m));
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    io.bunting.cli4j.parser.Parameterized other = (io.bunting.cli4j.parser.Parameterized) obj;
    if (m_field == null) {
