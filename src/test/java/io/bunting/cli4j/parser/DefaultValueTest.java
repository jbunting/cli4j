...
import io.bunting.cli4j.parser.internal.Sets;
...
public class DefaultValueTest {
  ...
  public void emptyDefaultValueForListParameterStaysEmptyIfNotAssignedOrIsSetOtherwise() {
    ...
    io.bunting.cli4j.parser.JCommander cmd = new io.bunting.cli4j.parser.JCommander(opts);
  ...
  private void testSettingMultipleValuesToListTypeParameters(MyOpts opts) {
    io.bunting.cli4j.parser.JCommander cmd = new JCommander(opts);
