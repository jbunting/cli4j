...
public class ParametersDelegateTest {
  ...
  public void combinedAndNestedDelegates() {
    ...
    Assert.assertEquals(p.nestedDelegate2.anonymousDelegate.getFloat(), 1.2f, 0.0001f);
...
//          expectedExceptionsMessageRegExp = ".*-a.*")
  ...
  @Test(expected = ParameterException.class)//, expectedExceptionsMessageRegExp = "Only one.*is allowed.*")
