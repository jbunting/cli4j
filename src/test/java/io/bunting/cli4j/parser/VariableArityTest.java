...
public class VariableArityTest {
  ...
  public static class ModelGenerationConfig {
    ...
    @io.bunting.cli4j.parser.Parameter(names = { "-m", "--matrixData" }, variableArity = true,
    ...
    @io.bunting.cli4j.parser.Parameter(names = { "-f", "--featureData" }, variableArity = true,
    ...
    @io.bunting.cli4j.parser.Parameter(names = { "-c", "--configData" }, variableArity = true,
        description = "File containing a list of configuration parameter values")
    public List<String> configFile = new LinkedList<String>();

    @io.bunting.cli4j.parser.Parameter(names = { "-o", "--outputFile" },
